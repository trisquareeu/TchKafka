        ...
        partitionData: [
          {
            ...
            records: [
              {
                key: Buffer.from('key-9d0f348cb2e730e1edc4key-9d0f348cb2e730e1edc4'),
                value: Buffer.from('some-value-a17b4c81f9ecd1e896e3key-9d0f348cb2e730e1edc4'),
                timestamp: 1509928155660,
                headers: { a: 'b', c: ['d', 'e'] }
              },
              {
                key: Buffer.from('key-c7073e965c34b4cc6442key-9d0f348cb2e730e1edc4'),
                value: Buffer.from('some-value-65df422070d7ad73914fkey-9d0f348cb2e730e1edc4'),
                timestamp: 1509928155660,
                headers: { a: 'b' }
              },
              {
                key: Buffer.from('key-1693b184a9b52dbe03bckey-9d0f348cb2e730e1edc4'),
                value: Buffer.from('some-value-3fcb65ffca087cba20adkey-9d0f348cb2e730e1edc4'),
                timestamp: 1509928155660,
                headers: { a: 'b' }
              }
            ]
