...
export class ShareGroupHeartbeatResponseV1Data {
  constructor(
  ...
  public static deserialize(buffer: ReadBuffer): ShareGroupHeartbeatResponseV1Data {
    ...
    return new ShareGroupHeartbeatResponseV1Data(
      throttleTimeMs,
      errorCode,
      errorMessage,
      memberId,
