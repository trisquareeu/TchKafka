...
export class PartitionV4 implements Serializable {
  constructor(
...
export class PartitionV4Factory extends PartitionFactoryTemplate<PartitionV4> {
  public create(): PartitionV4 {
    return new PartitionV4(
