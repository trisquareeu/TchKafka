...
import { ProduceResponseV8Data, ResponseHeaderV0 } from '../../responses';
import { type WriteBuffer } from '../../serialization';
import { type RequestHeaderV1 } from '../headers';
import { type Request } from '../request';
import { type TopicDataV8 } from './topic-data';

export class ProduceRequestV8 implements Request<ProduceResponseV8Data> {
  public readonly ExpectedResponseHeaderClass = ResponseHeaderV0;
  public readonly ExpectedResponseDataClass = ProduceResponseV8Data;
  ...
  constructor(
    ...
    public readonly topicData: Array<TopicDataV8>
  ) {}
