...
import { ProduceResponseV5Data, ResponseHeaderV0 } from '../../responses';
import { type WriteBuffer } from '../../serialization';
import { type RequestHeaderV1 } from '../headers';
import { type Request } from '../request';
import { type TopicDataV5 } from './topic-data';

export class ProduceRequestV5 implements Request<ProduceResponseV5Data> {
  public readonly ExpectedResponseHeaderClass = ResponseHeaderV0;
  public readonly ExpectedResponseDataClass = ProduceResponseV5Data;
  ...
  constructor(
    ...
    public readonly topicData: Array<TopicDataV5>
  ) {}
