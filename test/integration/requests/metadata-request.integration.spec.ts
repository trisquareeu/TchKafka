...
describe('MetadataRequest', () => {
  ...
  beforeEach(async () => {
    ...
    await kafkaContainerUtils.createTopic(topic);
  ...
  describe('v10', () => {
    it('should send the request and properly parse the response', async () => {
      const metadataRequestBuilder = new MetadataRequestBuilder(
        'someClientId',
        [{ id: randomUUID(), name: topic }],
        false,
        true,
        true
      );
  ...
  describe('v12', () => {
    it('should send the request and properly parse the response', async () => {
      const metadataRequestBuilder = new MetadataRequestBuilder(
        'someClientId',
        [{ name: topic, id: '0000-0000-0000-0000-0000' }],
        false,
        true,
        true
      );
