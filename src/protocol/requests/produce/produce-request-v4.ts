...
import { ProduceResponseV4Data, ResponseHeaderV0 } from '../../responses';
import { type WriteBuffer } from '../../serialization';
import { type RequestHeaderV1 } from '../headers';
import { type Request } from '../request';
import { type TopicDataV4 } from './topic-data';

export class ProduceRequestV4 implements Request<ProduceResponseV4Data> {
  public readonly ExpectedResponseHeaderClass = ResponseHeaderV0;
  public readonly ExpectedResponseDataClass = ProduceResponseV4Data;
  ...
  constructor(
    ...
    public readonly topicData: Array<TopicDataV4>
  ) {}
